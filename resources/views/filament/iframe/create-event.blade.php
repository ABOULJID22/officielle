@php
// Minimal wrapper that mounts the Filament create record page without full admin chrome.
// We mount the Filament CreateEvent page class by its class-based Livewire name.
@endphp
...
<body style="padding:16px; background:#f3f4f6; font-family: Inter, system-ui, -apple-system, 'Segoe UI', Roboto, 'Helvetica Neue', Arial;">
    @livewire(
        \App\Filament\Resources\Calendar\Pages\CreateEvent::class
    )
