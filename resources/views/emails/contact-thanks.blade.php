...
<head>
    ...
    <span style="display:none!important;visibility:hidden;opacity:0;color:transparent;height:0;width:0;overflow:hidden">Merci — confirmation de réception du message.</span>
</head>
<body>
    <div class="email-wrap">
        <div class="email-container" role="article" aria-roledescription="email" aria-label="Merci pour votre message">
            ...
            <div class="email-body">
                ...
                <p class="meta">Nous avons bien reçu votre message et vous remercions de nous avoir contactés. Notre équipe vous répondra dans les plus brefs délais.</p>

                <p style="margin-top:16px; color:#475569; font-size:13px;">Copie de votre message :</p>
                <div class="message-block">{!! nl2br(e($contact->message)) !!}</div>
            </div>

            <div class="email-footer">
                <div style="display:flex;align-items:center;justify-content:space-between;gap:12px;flex-wrap:wrap;">
                    <div>Offitrade — Cet email a été envoyé automatiquement.</div>
